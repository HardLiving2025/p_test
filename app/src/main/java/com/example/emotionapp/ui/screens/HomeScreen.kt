...
/** 탭 종류 */
enum class HomeTab { ANALYSIS, PREDICTION, NOTIFICATION, SETTINGS }

/** 기간 종류 */
enum class Period { YESTERDAY, WEEK, TWO_WEEKS, MONTH }
...
fun HomeScreen() {
    ...
    var showInsightPopup by remember { mutableStateOf(true) }
            ...
            periods.forEach { (id, label) ->
                ...
                Button(
                    ...
                    colors = ButtonDefaults.buttonColors(
                        containerColor = if (isSelected) AccentBlue else BackgroundBeige
                    ),
